ShopifyApp.configure do |config|
  ...
  config.api_key = ENV.fetch('SHOPIFY_API_KEY', '2254a5b4202a257e6e5c2e775d95469b').presence
  config.secret = ENV.fetch('SHOPIFY_API_SECRET', '8563ac8f6209023423548a4b7f72dfa7').presence
...
Rails.application.config.after_initialize do
  if ShopifyApp.configuration.api_key.present? && ShopifyApp.configuration.secret.present?
    ShopifyAPI::Context.setup(
      ...
      host_name: URI(ENV.fetch('HOST', 'https://morning-refuge-91620.herokuapp.com')).host || '',
